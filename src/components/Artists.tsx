  ...
  return (
    <section id="artists" className="relative overflow-hidden py-14 sm:py-18 lg:py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
          ...
          {mysterySlots.map((m, i) => (
            <Reveal key={m.label} delay={i * 0.08}>
              <div className="glass group relative flex h-44 flex-col items-center justify-center overflow-hidden rounded-xl text-center">
                ...
                <div className="mt-1 max-w-[80%] font-display text-[0.6rem] uppercase tracking-wide2 text-parchment/65">
                  {m.hint}
                </div>
                <div className="mt-3 rounded-full bg-gold/10 px-3 py-1 font-display text-[0.7rem] uppercase tracking-cinema text-gold-bright">
                  2026 · Reveal soon
                </div>
              </div>
            </Reveal>
        ...
        {/* past legends */}
        <Reveal>
          <div className="mt-16 flex items-center gap-3 font-display text-[0.62rem] uppercase tracking-cinema text-gold/70">
            <Star size={12} />
            ...
            <Reveal key={a.name} delay={i * 0.05}>
              <div className="group relative aspect-[3/4] overflow-hidden rounded-lg border border-gold/15">
                ...
                <div className="absolute inset-x-0 bottom-0 p-3">
                  ...
                  <div className="mt-0.5 font-display text-[0.7rem] uppercase tracking-wide2 text-parchment/70">
                    {a.role} · {a.year}
                  </div>
                </div>
              </div>

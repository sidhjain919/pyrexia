...
export const eventPhoto: Record<string, string> = {
  ...
  "Literary Escape Room": p('events/literary-escape-room.webp'),
  "Poetic Reveries": p('events/poetic-reveries.webp'),
  Declamation: p('events/declamation.webp'),
  Storysmiths: p('events/storysmiths.webp'),
  Logophilia: p('events/logophilia.webp'),
  ...
  "mADD Angle": p('events/madd-angle.webp'),

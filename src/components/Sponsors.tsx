        ...
        <Reveal>
          <div className="mt-16 flex flex-col items-center gap-4 rounded-2xl glass-parchment px-6 py-10 text-center">
            ...
            <button
              ...
              data-cursor="ALLY"
              className="rounded-full px-6 py-3 font-log text-[0.68rem] uppercase tracking-wide2 text-gold-bright ring-1 ring-inset ring-gold/40 transition-colors hover:bg-gold/10"
            >
              Become an Ally →
            </button>
          </div>
